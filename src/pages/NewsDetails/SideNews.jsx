...
function SideNews({ newsCategory }) {
  ...
  const {latestNews} = isClient ? useSelector((state) => state.news) : [];
  const [latestNewsNew, setLatestNews] = useState([]);
  
  const langContext = typeof window !== "undefined" ? useLanguage() : null;
